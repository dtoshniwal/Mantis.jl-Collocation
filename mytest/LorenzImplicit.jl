...
y1_n = TimeIntegrators.initializeScheme(y₀, method)
y2_n = TimeIntegrators.initializeScheme(y₀, method2)
...
for i=1:1000
    ...
    y1_n, y2_n, dt, t = TimeIntegrators.timeIntegrate(y1_n, y2_n, ode, t, dt)
